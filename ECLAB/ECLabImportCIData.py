...
class ECLabDataCI:
    ...
    def read_txt(self):
        self.file_paths = find_all_txt_files_containing_str(rootdir = self.file_folder, _str = '_CI_')
    ...
    def convert_to_RHE(self): 
        ...
        for file_name, data in self.data.items():
            ...
            print('que')
            data['Ru/Ohm'] = data['Rcmp/Ohm'].div(85).mul(100)
            if not self.R:
