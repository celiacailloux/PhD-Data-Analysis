...
#fit_info[detector]['CO']['start'] = 14.20 #GL note: Original setting 16.3 (at 30 degrees)
...
#This part is for fitting high current points
fit_info[detector]['H2'] = {} #P is for peak in spectrum, and are ordered from low to high in retentiontime
fit_info[detector]['H2']['start'] = 2.60 #GL note: Original setting 3.5 (at 30 degrees)
fit_info[detector]['H2']['end'] = 5.00 #GL note: Original setting 8 (at 30 degrees)
...
fit_info[detector]['CO2'] = {} #P is for peak in spectrum, and are ordered from low to high in retentiontime
fit_info[detector]['CO2']['start'] = 24.60 #GL note: Original setting 28 (at 30 degrees)
fit_info[detector]['CO2']['end'] = 28 #GL note: Original setting 38 (at 30 degrees)
...
#measurement_id = 224
filepath = r'/Users/celiacailloux/OneDrive - Danmarks Tekniske Universitet/PhD/Data/GC testdata/GL18012'
